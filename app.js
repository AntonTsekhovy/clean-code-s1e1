...
var incompleteTaskHolder = document.querySelector(".todo-list__inner"); //ul of #incompleteTasks
var completedTasksHolder = document.querySelector(".todo-complited__inner"); //completed-tasks
